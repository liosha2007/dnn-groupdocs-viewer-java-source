...
namespace Christoc.Modules.dnn_groupdocs_viewer_java.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.dnn_groupdocs_viewer_java.Data.SqlDataprovider,dnn_groupdocs_viewer_java";
